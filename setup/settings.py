...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.tech_assets.context_processors_add.verifica_movimentacoes',
                'apps.tech_assets.context_processors_add.verifica_aprovacoes_pendentes',
                'apps.tech_assets.context_processors_add.verifica_minhas_aprovacoes_pendentes',
