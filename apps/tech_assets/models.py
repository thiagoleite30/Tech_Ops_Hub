...
class AssetAllocation(models.Model):
    ...
    asset = models.ForeignKey(
        Asset, on_delete=models.CASCADE, related_name='allocation')
    ...
    def __str__(self):
        return f'{self.asset.nome} emprestado para {self.usuario.name} ({self.centro_de_custo.nome})'

    def save(self, *args, **kwargs):
        is_new = self.pk is None  # Verifica se é uma nova instância

        super(AssetAllocation, self).save(*args, **kwargs)
...
class Approval(models.Model):
    ...
    emprestimo = models.ForeignKey(
        AssetAllocation, on_delete=models.CASCADE, related_name='approver')
