    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('transferencia', 'Transferência'), ('emprestimo', 'Empréstimo'), ('baixa', 'Baixa')], default='emprestimo', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('em_uso', 'Em Uso'), ('transferido', 'Transferido'), ('em_manutencao', 'Em Manutenção'), ('em_estoque', 'Em Estoque'), ('baixado', 'Baixado'), ('separado', 'Separado'), ('nao_devolvido', 'Não Devolvido')], default='em_estoque', max_length=20)),
                ('mongo_id', models.CharField(max_length=100, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_logon', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pendente_aprovacao', 'Aprovação Pendente'), ('pendente_entrega', 'Pendente Entrega'), ('em_devolucao', 'Devolução em Andamento'), ('em_andamento', 'Em Andamento'), ('concluido', 'Concluído'), ('atrasado', 'Atrasado')], default='pendente_aprovacao', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantidade_devolvida', models.PositiveIntegerField(blank=True, default=0, null=True)),
        ...
        migrations.AddField(
            model_name='movement',
            name='ativos',
            field=models.ManyToManyField(blank=True, through='tech_assets.MovementAsset', to='tech_assets.asset'),
        ),
        migrations.CreateModel(
            name='NetworkDevice',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_recebedor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_recept_return', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Termo',
            fields=[
                ...
                ('aceite_usuario', models.CharField(choices=[('aceito', 'Aceito'), ('pendente', 'Pendente'), ('recusado', 'Recusado'), ('pendente_aceite_novos_termos', 'Pendente Aceitação de Novos Termos')], default='pendente', max_length=100)),
                ...
                ('conteudo_termo', models.ForeignKey(default=apps.tech_assets.models.get_latest_termo_version, on_delete=django.db.models.deletion.PROTECT, related_name='termos', to='tech_assets.conteudotermo')),
                ('movimentacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='termo_movimentacao', to='tech_assets.movement')),
            ],
        ),
    ]
