    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('em_uso', 'Em Uso'), ('transferido', 'Transferido'), ('em_manutencao', 'Em Manutenção'), ('em_estoque', 'Em Estoque'), ('baixado', 'Baixado'), ('separado', 'Separado')], default='em_estoque', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pendente_aprovacao', 'Aprovação Pendente'), ('pendente_entrega', 'Pendente Entrega'), ('em_andamento', 'Em Andamento'), ('concluido', 'Concluído'), ('atrasado', 'Atrasado')], default='pendente_aprovacao', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ass_usuario_recebedor', models.BooleanField(default=False)),
                ('ass_usuario', models.BooleanField(default=False)),
                ('movimentacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='returned', to='tech_assets.movement')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_send_return', to=settings.AUTH_USER_MODEL)),
                ('usuario_recebedor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_recept_return', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Termo',
